...
module.exports = {
  ...
  GetWxPay: ApiRootUrl + 'weixin/wxpay',
  ...
  CustomerRegister: ApiRootUrl + 'weixin/login',
  UserAdd: ApiRootTestUrl + 'user/add',
  UserRegister: ApiRootUrl + 'barber/add',
  Sendsms: ApiRootUrl + 'barber/sendsms',
  ...
  BarberSubscribeManage: ApiRootUrl + 'barber/getsubscribemanagement',
